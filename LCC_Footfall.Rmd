...
The goal of this module is to compare the performance of the R version with the Python version, before the integration of the former into a web-based tool designed for daily prediction of footfall data in Leeds City Centre.
